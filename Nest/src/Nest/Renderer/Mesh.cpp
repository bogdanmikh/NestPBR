...
void Mesh::create(const VertexBufferLayout &layout, float *vertices, unsigned int verticesCount, unsigned int *indices, unsigned int indicesCount) {
...
void Mesh::create(Vertex *vertices, unsigned int verticesCount, unsigned int *indices, unsigned int indicesCount) {
    ib = new IndexBuffer(indices, indicesCount);
